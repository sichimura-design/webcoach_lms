...
import { Bot, BrainCircuit, FolderOpen, ImageUp, KeyRound, PlusCircle, UserCircle2, Users, Link2, Video, Settings } from 'lucide-react';
...
const sidebarItems = [
  ...
  { to: '/admin/coach-integrations', label: '録画連携', icon: Video },
