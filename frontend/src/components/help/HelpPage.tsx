...
const MANUAL_SECTIONS: Section[] = [
  {
    id: 'start',
    title: '1. まずはここから',
    lead: 'ログインすると最初にトップが開きます。今日やることはこの1画面で分かります。',
    body: [
  ...
  },
  {
    ...
    body: [
      'トップ … 今日やることの起点。学習時間や連続日数もここに出ます。',
      '学習する … 受講できるコースを探し、教材を進める。集中ブース（タイマー）もここから。',
      'AIコーチ … 分からないことを相談する。',
      'コーチング … 次回の予定、これまでの記録、次回までの目標。学習ロードマップもここにあります。',
      'マイノート … 教材のクリップ・AIの回答・自分で書いたノートが貯まる場所。',
  ...
  },
  {
    ...
    title: '3. レッスンの進め方',
    body: [
      '「学習する」からコースを選ぶと、コーストップ（カリキュラム）が開きます。',
      'STEPごとに単元がまとまっています。「はじめる」「続きから」「復習する」は、その単元の進み具合で自動的に切り替わります。',
      'レッスン画面は3ペイン構成です。左の目次、中央の本文、右のサポート（AIコーチ・マイノート）をそれぞれ開閉できます。',
      '本文を読み終えたら完了操作をしてください。コーストップの進捗率に反映され、次のレッスンへ進めます。完了は後から取り消せます。',
    ],
  },
  {
    id: 'focus',
    title: '4. 集中して学ぶ（集中ブース）',
    body: [
      '「学習する」の右上にある集中ブースで、教材と今回の目標を決めてタイマーを開始します。',
      '終了すると終了カードが出ます。振り返りを記入すると学習記録に残ります。',
      '記録した時間は、学習記録・トップの学習時間・学習日数すべてに同じ値で反映されます。',
    ],
  },
  {
    id: 'ai',
    ...
    body: [
      ...
      '残した回答・書いた文章・クリップは「マイノート」にまとまります。マイノートからは元のレッスンの位置に戻れます。',
  ...
  },
  {
    ...
    body: [
      ...
      'コーチングが終わると要約が生成されます。内容を確認して確定すると、決まった目標がトップの「次回コーチングまでのTODO」に入ります。',
      '目標の追加・修正・完了チェックも「コーチング」で行います。',
    ],
  },
  {
    id: 'roadmap',
...
const FAQ_ITEMS: FaqItem[] = [
  ...
  {
    q: '前回の続きが分かりません',
    a: ['トップの「続きから学習する」を押してください。最後に学習していたコースの続きに戻れます。'],
  },
  {
  ...
  },
  {
    q: '学習時間が記録されていません',
    a: [
      '学習時間は集中ブースや教材画面でタイマーを使ったときに記録されます。教材を開いているだけでは記録されません。',
  ...
  },
  {
    ...
    a: [
      ...
      '今日ぶんが未達成のときは、あと何分で成立するかがトップに出ます。',
    ],
  },
  {
    q: 'AIコーチの回答は正しいですか',
  ...
  },
  {
    ...
    a: [
      '同意しないままコーチングを受けられます。その場合は録画・文字起こし・自動要約が行われず、目標の自動取り込みも行われません。',
      '目標は「コーチング」から手動で登録できます。',
    ],
  },
  {
    q: 'ロードマップの予定より遅れています',
