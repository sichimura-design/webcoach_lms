...
const MANUAL_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'AIコーチ … 分からないことを相談する。',
      'コーチング … コーチとの面談の予定・記録・目標。学習ロードマップもここにあります。',
      'マイノート … 教材のクリップ・AIの回答・自分のメモが貯まる場所。',
  ...
  },
  {
    ...
    body: [
      ...
      '面談が終わると要約が生成されます。内容を確認して確定すると、決まった目標がトップの「次回コーチングまでの目標」に入ります。',
