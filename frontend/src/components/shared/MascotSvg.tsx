...
function MascotSvg({ size = 64, cheeks = false, pulse = false, flag = false, style }: MascotSvgProps) {
  return (
    ...
    >
      <line x1="32" y1="10" x2="32" y2="16" stroke="#D60934" strokeWidth="2" />
      <circle cx="32" cy="8" r="3.4" fill="#D60934" />
      ...
      <path d="M28 35 q4 3.4 8 0" stroke="#D60934" strokeWidth="2" fill="none" strokeLinecap="round" />
      {cheeks && (
        <>
      ...
      <rect x="20" y="46" width="24" height="12" rx="6" fill="#D60934" />
      {flag && (
        <>
          <line x1="50" y1="30" x2="56" y2="18" stroke="#C97" strokeWidth="2" />
          <path d="M56 18 l8 3 -8 3 z" fill="#D60934" />
        </>
      )}
    </svg>
  );
